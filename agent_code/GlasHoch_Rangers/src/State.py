...
class State:
    ...
    def get_features(self, game_state):
        ...
        explosion_map_ongoing = game_state['explosion_map']
        explosion_map_ongoing[explosion_map_ongoing > 0] = 4
        explosion_map = np.maximum(explosion_map, explosion_map_ongoing)
